...
### 7. Get Subject Schedule Template
...
- `page`: `integer` (optional, default: 1)
- `limit`: `integer` (optional, default: 10)
- `search`: `string` (optional) - Search by fullName, teacherId, emailAddress, or phoneNumber
- `soo`: `string` (optional) - Filter by State of Origin
- `assignedClassId`: `uuid` (optional) - Filter by assigned class
- `gender`: `string` (optional, enum: `Male`, `Female`, `Other`)
  ...
  "data": [
    {
      ...
      "emailAddress": "garyjb@sbcglobal.net",
      "gender": "Male",
      "phoneNumbers": ["+23458400434", "+23480090400"],
      "profilePictureUrl": "string (optional)",
      "createdAt": "datetime",
      "updatedAt": "datetime"
    },
    {
      ...
      "emailAddress": "hwestiii@outlook.com",
      "gender": "Female",
      "phoneNumbers": ["+23458400435"],
      "profilePictureUrl": "string (optional)",
      "createdAt": "datetime",
      "updatedAt": "datetime"
    }
...
```json
{
  ...
  "data": {
    "id": "uuid",
    "teacherId": "string (auto-generated if not provided)",
    "fullName": "string",
    "soo": "string",
    "assignedClasses": [],
    "emailAddress": "string",
...
**Endpoint:** `DELETE /api/admin/teachers/{teacherId}/assigned-class/{classArmId}`
...
### 8. Get Available Classes for Assignment
...
### 9. Get States of Origin (SOO)

**Endpoint:** `GET /api/admin/lookup/states`
...
#### 11.2 Bulk Update Teacher Status
**Endpoint:** `PUT /api/admin/teachers/bulk-update`
...
### 12. Export Teachers Data

**Endpoint:** `GET /api/admin/teachers/export`

**Headers:** `Authorization: Bearer {admin_token}`

**Query Parameters:**
- `format`: `string` (PDF | CSV | EXCEL)
- `includePerformance`: `boolean` (optional, default: false)
- `filters`: `string` (optional, JSON string of filters)

**Response:** File download with teachers data
...
- `INSUFFICIENT_PERMISSIONS`: User doesn't have permission to manage teachers
- `BULK_IMPORT_ERROR`: Error in bulk import process
- `INVALID_SOO`: Invalid State of Origin

### Performance Considerations

- Implement pagination for large teacher lists
- Use database indexes on frequently searched fields (teacherId, email, fullName, soo)
- Cache teacher lists for 5-10 minutes
- Implement search with full-text indexing
- Use database transactions for bulk operations
- Implement soft deletes for teacher records

This comprehensive API specification covers all the functionality needed for the Teachers management UI, including CRUD operations, class assignments, performance tracking, and bulk operations, while addressing the UI inconsistencies by focusing on teacher-relevant data fields.
